        ...
        datasets: [
          {
            ...
            // data: [0, 0, 0, 0, 0, 0, 30, 0, 0, 0, 0, 0],
            fill: true,
            borderWidth: 2,
            lineTension: 0,
            pointRadius: 5,
            pointHitRadius: 5,
            pointHoverHitRadius: 6,
            pointHoverRadius: 6,
            pointHoverBorderColor: '#4e78fe',
            pointBorderColor: "#4e78fe",
            pointBackgroundColor: "#fff",
            borderColor: "#4e78fe"
            // pointHoverBorderColor: '#fa8964',
            // pointBorderColor: "#fa8964",
            // pointBackgroundColor: "#fff",
            // borderColor: "#fa8964"
          }
        ]
