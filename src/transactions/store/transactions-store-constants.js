...
// export const AWS_BUCKET = 'mbackofficedata'
export const ACCESS_KEY_ID = 'AKIAW2IFYS7JGKH77NWJ'
export const SECRET_ACCESS_KEY = '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'
