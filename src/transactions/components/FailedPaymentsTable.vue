<template>
    <div class="transactions">
        <div class="trans-div flex">
            <div>
                <filter-component dispatch="setFailedFilters" filterType="failed"></filter-component>
            </div>
            <div>
        ...
        <div>
            ...
            <div v-else>
                <el-table
                @row-click="clickRow"
                empty-text="No failed transactions, filter desired period range"
                v-loading="loading"
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange (val) {
        this.$store.dispatch('getFailed', {page: val, cache: false})
    },
